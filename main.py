...
Item(name="Copper Ore", type="item", stack_size=50)
Recipe(name="Copper Mining", type="recipe", ingredients=[("Copper Ore", 1)], result="Copper Ore")
Item(name="Iron Ore", type="item", stack_size=50)
Recipe(name="Iron Mining", type="recipe", ingredients=[("Iron Ore", 1)], result="Iron Ore")
Item(name="Stone Ore", type="item", stack_size=50)
Recipe(name="Stone Mining", type="recipe", ingredients=[("Stone Ore", 1)], result="Stone Ore")

Item(name="Copper Plate", type="item", stack_size=100)
Recipe(name="Copper Smelting", type="recipe", ingredients=[("Copper Ore", 2)], result="Copper Plate")
Item(name="Iron Plate", type="item", stack_size=100)
Recipe(name="Iron Smelting", type="recipe", ingredients=[("Iron Ore", 2)], result="Iron Plate")
...
# copper_ore = Item(name="Copper Ore", type="item", stack_size=50)
# copper_mining = Recipe(name="Copper Mining", type="recipe", ingredients=[("Copper Ore", 1)], result="Copper Ore")
#
# # Access instances by name
# copper_ore_instance = Item.get_instance("Copper Ore")
# copper_mining_instance = Recipe.get_instance("Copper Mining")
#
# # Get a dictionary of all instances
# item_instances = Item.get_all_instances()
# recipe_instances = Recipe.get_all_instances()
#
# print(item_instances)
# print(recipe_instances)
